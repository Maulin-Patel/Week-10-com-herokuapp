 ...
 * 2. Open URL http://the-internet.herokuapp.com/login
...
public class ChromeBrowserTest {
    public static void main(String[] args) {
        ...
        driver.get("http://the-internet.herokuapp.com/login"); // Opening provided url in Chrome Browser
        ...
        driver.findElement(By.id("username")).sendKeys("maulin1@gmail.com"); // Finding username field with id Locator and passing value to put into username field
